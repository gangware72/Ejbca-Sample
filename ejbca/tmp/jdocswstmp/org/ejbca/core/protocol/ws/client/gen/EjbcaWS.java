...
/**
	 ...
	 * @throws EjbcaException_Exception if an error occurred
	 * @see RevokeStatus
	 */
 public boolean isAuthorized(String resource) throws EjbcaException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws UserDoesntFullfillEndEntityProfile_Exception if we add or edit a profile that doesn't match its end entity profile.
	 * @throws WaitingForApprovalException_Exception The request ID will be included as a field in this exception.
	 * @throws EjbcaException_Exception if an error occurred
	 */
 public void editUser(UserDataVOWS userData) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, UserDoesntFullfillEndEntityProfile_Exception, WaitingForApprovalException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws IllegalQueryException_Exception if query isn't valid
	 * @throws EjbcaException_Exception if an error occurred
	 * @throws EndEntityProfileNotFoundException_Exception if an end entity profile was not found.
	 */
 public List<UserDataVOWS> findUser(UserMatch usermatch) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, EndEntityProfileNotFoundException_Exception, IllegalQueryException_Exception;
...
/**
	 ...
	 * @throws EjbcaException_Exception if an error occurred
	 */
 public List<Certificate> findCerts(String username, boolean onlyValid) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws AuthorizationDeniedException_Exception if the client does not fulfill the authorization requirements specified above
     * @throws EjbcaException_Exception on internal errors, such as badly encoded certificate
     */
 public List<Certificate> getLastCertChain(String username) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 */
 public void createCryptoToken(String tokenName, String tokenType, String activationPin, boolean autoActivate, List<KeyValuePair> cryptoTokenProperties) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws EjbcaException_Exception if an error occurred
	 */
 public void generateCryptoTokenKeys(String cryptoTokenName, String keyPairAlias, String keySpecification) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 */
 public void createCA(String caName, String caDn, String caType, long validityInDays, String certProfile, String signAlg, int signedByCAId, String cryptoTokenName, List<KeyValuePair> purposeKeyMapping, List<KeyValuePair> caProperties) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
     ...
     *
     * @throws EjbcaException_Exception for any failures, the true error cause will be wrapped inside.
     */
 public byte[] createExternallySignedCa(String caName, String caDn, String caType, long validityInDays, String certProfile, String signAlg, String cryptoTokenName, List<KeyValuePair> purposeKeyMapping, List<KeyValuePair> caProperties) throws EjbcaException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 */
 public void addSubjectToRole(String roleName, String caName, String matchWith, String matchType, String matchValue) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 */
 public void removeSubjectFromRole(String roleName, String caName, String matchWith, String matchType, String matchValue) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if at least one of the certificates is unreadable
     */
 public List<Certificate> getCertificatesByExpirationTime(long days, int maxNumberOfResults) throws EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if at least one of the certificates is unreadable
     */
 public List<Certificate> getCertificatesByExpirationTimeAndIssuer(long days, String issuerDN, int maxNumberOfResults) throws EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if at least one of the certificates is unreadable
     */
 public List<Certificate> getCertificatesByExpirationTimeAndType(long days, int certificateType, int maxNumberOfResults) throws EjbcaException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws NotFoundException_Exception if an object cannot be found in the database
	 * @throws EjbcaException_Exception if an error occurred
	 * @throws CesecoreException_Exception if an error occurred
	 */
 public CertificateResponse crmfRequest(String username, String password, String crmf, String hardTokenSN, String responseType) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, CesecoreException_Exception, EjbcaException_Exception, NotFoundException_Exception;
...
/**
	 ...
	 * @throws CesecoreException_Exception if an error occurred
	 */
 public CertificateResponse spkacRequest(String username, String password, String spkac, String hardTokenSN, String responseType) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, CesecoreException_Exception, EjbcaException_Exception, NotFoundException_Exception;
...
/**
	 ...
	 *
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if administrator is not authorized to edit end entity or if an authenticated request can not be verified
	 * @throws SignRequestException_Exception if the provided request is invalid, for example not containing a username or password
	 * @throws UserDoesntFullfillEndEntityProfile_Exception if we add or edit a profile that doesn't match its end entity profile.
	 * @throws NotFoundException_Exception if an object cannot be found in the database
	 * @throws EjbcaException_Exception for other errors, an error code like ErrorCode.SIGNATURE_ERROR (popo/inner signature verification failed) is set.
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws WaitingForApprovalException_Exception The request ID will be included as a field in this exception.
	 * @throws CertificateExpiredException_Exception if certificate expired.
	 * @throws CesecoreException_Exception if an error occurred
	 * @see org.cesecore.ErrorCode
	 */
 public List<Certificate> cvcRequest(String username, String password, String cvcReq) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, CertificateExpiredException_Exception, CesecoreException_Exception, EjbcaException_Exception, NotFoundException_Exception, SignRequestException_Exception, UserDoesntFullfillEndEntityProfile_Exception, WaitingForApprovalException_Exception;
...
/** Generates a Certificate Signing Request (CSR) from a CA. The CSR can be sent to another CA to be signed, thus making the CA a sub CA of the signing CA.
     ...
     *
	 * @throws CADoesntExistsException_Exception if CA name does not exist
	 * @throws AuthorizationDeniedException_Exception if administrator is not authorized to create request, renew keys etc.
	 * @throws ApprovalException_Exception if a non-expired approval for this action already exists, i.e. the same action has already been requested.
	 * @throws WaitingForApprovalException_Exception if the operation requires approval from another CA administrator, in this case an approval request is created for another administrator to approve. The request ID will be included as a field in this exception.
	 * @throws EjbcaException_Exception other errors in which case an org.ejbca.core.ErrorCode is set in the EjbcaException
	 */
 public byte[] caRenewCertRequest(String caName, List<byte[]> caChain, boolean regenerateKeys, boolean useNextKey, boolean activateKey, String keystorePwd) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, WaitingForApprovalException_Exception;
...
/**
	 ...
	 *
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws CAExistsException_Exception if a CA with that logical name or CA certificate subject DN already exists.
	 * @throws EjbcaException_Exception if an other exception occurs.
	 */
 public void importCaCert(String caName, byte[] certBytes) throws AuthorizationDeniedException_Exception, CAExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 *
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws CADoesntExistsException_Exception if a CA with that logical name does not exists in EJBCA.
	 * @throws EjbcaException_Exception if an other exception occurs.
	 */
 public void updateCaCert(String caName, byte[] certBytes) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/** Receives a certificate as a response to a CSR from the CA. The CSR might have been generated using the caRenewCertRequest.
	 ...
	 * @throws AuthorizationDeniedException_Exception if administrator is not authorized to import certificate.
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws WaitingForApprovalException_Exception if the operation requires approval from another CA administrator, in this case an approval request is created for another administrator to approve. The request ID will be included as a field in this exception.
	 * @throws EjbcaException_Exception other errors in which case an org.ejbca.core.ErrorCode is set in the EjbcaException
	 * @throws CesecoreException_Exception if an error occurred
	 */
 public void caCertResponse(String caName, byte[] cert, List<byte[]> caChain, String keystorePwd) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CesecoreException_Exception, EjbcaException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws CesecoreException_Exception if an error occurred
	 */
 public void caCertResponseForRollover(String caName, byte[] cert, List<byte[]> caChain, String keystorePwd) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CesecoreException_Exception, EjbcaException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception other errors in which case an org.ejbca.core.ErrorCode is set in the EjbcaException
     */
 public void rolloverCACert(String caName) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws NotFoundException_Exception if user cannot be found
	 * @throws EjbcaException_Exception if an error occurred
	 * @throws CesecoreException_Exception if an error occurred
	 */
 public CertificateResponse pkcs10Request(String username, String password, String pkcs10, String hardTokenSN, String responseType) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, CesecoreException_Exception, EjbcaException_Exception, NotFoundException_Exception;
...
/**
	 ...
	 * @throws EjbcaException_Exception if an error occurred
	 */
 public KeyStore pkcs12Req(String username, String password, String hardTokenSN, String keySpec, String keyAlg) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception;
...
/**
	 ...
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws WaitingForApprovalException_Exception The request ID will be included as a field in this exception.
	 * @throws AlreadyRevokedException_Exception if certificate was already revoked, or you tried to unrevoke a permanently revoked certificate
	 */
 public void revokeCert(String issuerDN, String certificateSN, int reason) throws AlreadyRevokedException_Exception, ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception, WaitingForApprovalException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized.
	 * @throws NotFoundException_Exception if certificate doesn't exist
	 * @throws WaitingForApprovalException_Exception If request has bean added to list of tasks to be approved. The request ID will be included as a field in this exception.
	 * @throws ApprovalException_Exception There already exists an approval request for this task.
	 * @throws AlreadyRevokedException_Exception The certificate was already revoked, or you tried to unrevoke a permanently revoked certificate
	 * @throws EjbcaException_Exception internal error
	 * @throws RevokeBackDateNotAllowedForProfileException_Exception if back date is not allowed in the certificate profile
	 * @throws DateNotValidException_Exception if the date is not a valid ISO 8601 string or if it is in the future.
	 */
 public void revokeCertBackdated(String issuerDN, String certificateSN, int reason, String sDate) throws AlreadyRevokedException_Exception, ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, DateNotValidException_Exception, EjbcaException_Exception, NotFoundException_Exception, RevokeBackDateNotAllowedForProfileException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws RevokeBackDateNotAllowedForProfileException_Exception if back date is not allowed in the certificate profile
     * @throws DateNotValidException_Exception if the date is not a valid ISO 8601 string or if it is in the future.
	 * @throws CertificateProfileDoesNotExistException_Exception if no profile was found with certRevocationDto.certificateProfileId input parameter.
     */
 public void revokeCertWithMetadata(String issuerDN, String certificateSN, List<KeyValuePair> metadata) throws AlreadyRevokedException_Exception, ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, DateNotValidException_Exception, EjbcaException_Exception, NotFoundException_Exception, RevokeBackDateNotAllowedForProfileException_Exception, WaitingForApprovalException_Exception, CertificateProfileDoesNotExistException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist.
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized.
	 * @throws NotFoundException_Exception if user doesn't exist.
	 * @throws WaitingForApprovalException_Exception if request has bean added to list of tasks to be approved. The request ID will be included as a field in this exception.
	 * @throws ApprovalException_Exception if there already exists an approval request for this task.
	 * @throws AlreadyRevokedException_Exception if the user already was revoked.
	 * @throws EjbcaException_Exception any EjbcaException.
	 * @see RevokeStatus
	 */
 public void revokeUser(String username, int reason, boolean deleteUser) throws AlreadyRevokedException_Exception, ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception, WaitingForApprovalException_Exception;
...
/**
	 ...
	 * @throws WaitingForApprovalException_Exception if request has bean added to list of tasks to be approved. The request ID will be included as a field in this exception.
	 * @throws ApprovalException_Exception if there already exists an approval request for this task
	 * @throws EjbcaException_Exception if there is a configuration or other error
	 */
 public void keyRecoverNewest(String username) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if there is a configuration or other error
     */
 public void keyRecover(String username, String certSNinHex, String issuerDN) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @param hardTokenSN Hard Token support was dropped since 7.1.0. Use null as this parameter
     * @return the generated keystore
     * @throws AuthorizationDeniedException_Exception if the requesting administrator is unauthorized to perform this operation
     * @throws CADoesntExistsException_Exception referenced CA cannot be found in any EJBCA instance
     * @throws WaitingForApprovalException_Exception if the request has bean added to list of tasks to be approved. The request ID will be included as a field in this exception.
     * @throws EjbcaException_Exception other exceptions
     */
 public KeyStore keyRecoverEnroll(String username, String certSNinHex, String issuerDN, String password, String hardTokenSN) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, CADoesntExistsException_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
     * @throws NotFoundException_Exception if an object cannot be found in the database
     * @throws EjbcaException_Exception Always thrown with error code set to ErrorCode.INTERNAL_ERROR
     * @throws ApprovalException_Exception if there is already a request waiting for approval.
     * @throws WaitingForApprovalException_Exception The request ID will be included as a field in this exception.
     * @throws AlreadyRevokedException_Exception if certificate was already revoked, or you tried to unrevoke a permanently revoked certificate
     * @deprecated Removed in EJBCA 7.1.0
     */
 public void revokeToken(String hardTokenSN, int reason) throws AlreadyRevokedException_Exception, ApprovalException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, NotFoundException_Exception, WaitingForApprovalException_Exception;
...
/**
	 ...
	 * @see RevokeStatus
	 */
 public RevokeStatus checkRevokationStatus(String issuerDN, String certificateSN) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws UserDataSourceException_Exception if an error occurred connecting to one of UserDataSources
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws EjbcaException_Exception if an error occurred
	 */
 public List<UserDataSourceVOWS> fetchUserData(List<String> userDataSourceNames, String searchString) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, UserDataSourceException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 * @throws WaitingForApprovalException_Exception The request ID will be included as a field in this exception.
	 * @throws HardTokenExistsException_Exception if hard token exists.
	 * @throws UserDoesntFullfillEndEntityProfile_Exception if we add or edit a profile that doesn't match its end entity profile.
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws EjbcaException_Exception Always thrown with error code set to ErrorCode.INTERNAL_ERROR
	 * @throws ApprovalRequestExpiredException_Exception Throws this exception one time if one of the approvals have expired, once notified it won't throw it anymore.
	 * @throws ApprovalRequestExecutionException_Exception if approval request execution failed.
	 * @deprecated Removed in EJBCA 7.1.0
	 */
 public List<TokenCertificateResponseWS> genTokenCertificates(UserDataVOWS userData, List<TokenCertificateRequestWS> tokenRequests, HardTokenDataWS hardTokenData, boolean overwriteExistingSN, boolean revokePreviousCards) throws ApprovalException_Exception, ApprovalRequestExecutionException_Exception, ApprovalRequestExpiredException_Exception, AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, HardTokenExistsException_Exception, UserDoesntFullfillEndEntityProfile_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @deprecated Removed in EJBCA 7.1.0
     */
 public boolean existsHardToken(String hardTokenSN) throws EjbcaException_Exception;
...
/**
     ...
     * @throws CADoesntExistsException_Exception if a referenced CA does not exist
     * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
     * @throws HardTokenDoesntExistsException_Exception if hard token doesn't exist
     * @throws NotFoundException_Exception if an object cannot be found in the database
...
/**
     ...
     * @deprecated Removed in EJBCA 7.1.0
     */
 public List<HardTokenDataWS> getHardTokenDatas(String username, boolean viewPUKData, boolean onlyValidCertificates) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if the administrator isn't authorized to republish
	 * @throws PublisherException_Exception if something went wrong during publication
	 * @throws EjbcaException_Exception if other error occurred on the server side.
	 */
 public void republishCertificate(String serialNumberInHex, String issuerDN) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception, PublisherException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if the administrators isn't authorized to log.
	 * @throws EjbcaException_Exception if error occurred server side
	 */
 public void customLog(int level, String type, String caName, String username, Certificate certificate, String msg) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if the user isn't authorized to remove userdata from any of the specified user data sources
	 * @throws MultipleMatchException_Exception if the search string resulted in a multiple match and the removeMultipleMatch was set to false.
	 * @throws UserDataSourceException_Exception if an error occurred during the communication with the user data source.
	 * @throws EjbcaException_Exception if error occurred server side
	 */
 public boolean deleteUserDataFromSource(List<String> userDataSourceNames, String searchString, boolean removeMultipleMatch) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, MultipleMatchException_Exception, UserDataSourceException_Exception;
...
/**
	 ...
	 * @throws ApprovalException_Exception if approvalId does not exist
	 * @throws ApprovalRequestExpiredException_Exception Throws this exception one time if one of the approvals have expired, once notified it won't throw it anymore.
	 * @throws EjbcaException_Exception if error occurred server side
     * @see #getRemainingNumberOfApprovals
	 */
 public int isApproved(int approvalId) throws ApprovalException_Exception, ApprovalRequestExpiredException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws ApprovalException_Exception if a request of the given ID didn't exist
	 * @throws AuthorizationDeniedException_Exception if the current requester wasn't authorized.
     * @throws ApprovalRequestExpiredException_Exception if approval request was expired before having a definite status
	 */
 public int getRemainingNumberOfApprovals(int requestId) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, ApprovalRequestExpiredException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws AuthorizationDeniedException_Exception if the calling administrator isn't authorized to view the certificate
	 * @throws EjbcaException_Exception if error occurred server side
	 */
 public Certificate getCertificate(String certSNinHex, String issuerDN) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 */
 public List<NameAndId> getAvailableCertificateProfiles(int entityProfileId) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws AuthorizationDeniedException_Exception if client isn't authorized to request
	 */
 public List<NameAndId> getAvailableCAsInProfile(int entityProfileId) throws AuthorizationDeniedException_Exception, EjbcaException_Exception;
...
/**
	 ...
	 * @throws EjbcaException_Exception if a profile of the specified type was not found
	 * @throws AuthorizationDeniedException_Exception if the requesting user wasn't authorized to the requested profile
	 * @throws UnknownProfileTypeException_Exception if the submitted profile type was not 'eep' or 'cp'
	 */
 public byte[] getProfile(int profileId, String profileType) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, UnknownProfileTypeException_Exception;
...
/**
	 ...
	 * @throws CADoesntExistsException_Exception if a referenced CA does not exist
	 * @throws ApprovalException_Exception if there is already a request waiting for approval.
	 * @throws EjbcaException_Exception if an error occurred, for example authorization denied
	 * @throws ApprovalRequestExpiredException_Exception Throws this exception one time if one of the approvals have expired, once notified it won't throw it anymore.
	 * @throws CAOfflineException_Exception if CA is offline.
	 * @throws CryptoTokenOfflineException_Exception if CA Token that isn't available
	 */
 public void createCRL(String caName) throws ApprovalException_Exception, ApprovalRequestExpiredException_Exception, CADoesntExistsException_Exception, CAOfflineException_Exception, CryptoTokenOfflineException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if an error occurred, for example authorization denied
     */
 public byte[] getLatestCRL(String caName, boolean deltaCRL) throws CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if an error occurred, for example authorization denied
     */
 public byte[] getLatestCRLPartition(String caName, boolean deltaCRL, int crlPartitionIndex) throws CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws EjbcaException_Exception if an error occurred
     */
 public int getPublisherQueueLength(String name) throws EjbcaException_Exception;
...
/**
	 ...
	 * @throws NotFoundException_Exception if user cannot be found
	 * @throws UserDoesntFullfillEndEntityProfile_Exception if we add or edit a profile that doesn't match its end entity profile.
	 * @throws ApprovalException_Exception thrown if a end needs to be created as part of this request, but that action requires approvals.
	 * @throws WaitingForApprovalException_Exception never thrown, but remains for legacy reasons.
	 * @throws EjbcaException_Exception if an error occurred
	 * @see #editUser(UserDataVOWS)
	 */
 public CertificateResponse certificateRequest(UserDataVOWS userData, String requestData, int requestType, String hardTokenSN, String responseType) throws ApprovalException_Exception, AuthorizationDeniedException_Exception, EjbcaException_Exception, NotFoundException_Exception, UserDoesntFullfillEndEntityProfile_Exception, WaitingForApprovalException_Exception;
...
/**
     ...
     * @throws AuthorizationDeniedException_Exception if the client does not fulfill the authorization requirements specified above
     * @throws CADoesntExistsException_Exception if the CA with the CA name given as input does not exist
     * @throws EjbcaException_Exception on internal errors, such as badly encoded certificate
     */
 public List<Certificate> getLastCAChain(String caName) throws AuthorizationDeniedException_Exception, CADoesntExistsException_Exception, EjbcaException_Exception;
...
/**
     ...
     * @throws SshKeyException_Exception if the CA was not a SSH CA, or if there was an error in encoding the key.
     * @throws CADoesntExistsException_Exception if no CA by that name was found.
     */
 public byte[] getSshCaPublicKey(String caName) throws CADoesntExistsException_Exception, SshKeyException_Exception;
...
/**
     ...
     * @throws AuthorizationDeniedException_Exception if the caller doesn't have authorization to enroll end entities
     * @throws EjbcaException_Exception if an error occurred
     * @throws EndEntityProfileValidationException_Exception if someone tries to add or edit an end entity that doesn't match its profile.
     */
 public byte[] enrollAndIssueSshCertificate(UserDataVOWS userDataVOWS, SshRequestMessageWs sshRequestMessage) throws AuthorizationDeniedException_Exception, EjbcaException_Exception, EndEntityProfileValidationException_Exception;
}
